...
This program demonstrates the development of a class called MotorDriver utilized to drive motors in lab. This code was tested an ran
with the in Lab 2 with various duty cycles to examine if the code was running correctly.
